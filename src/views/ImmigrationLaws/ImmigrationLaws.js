...
import { docsForGreenCrdContent, immigrationLawsParaContent, immigrationProcessAndInterview, prepForIntrvw } from '../../constants/JSONS';
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <div class="leftTabList">
                                            <ul>
                                                <li class={getLocationParaCount(pageLocation) == 1 || getCurrentState(pageLocation, "fncs") === true ? `active` : ""}><a href="#fncs">Fiances</a></li>
                                                <li class={getCurrentState(pageLocation, "spss") === true ? `active` : ""}><a href="#spss">Spouses</a></li>
                                                <li class={getCurrentState(pageLocation, "grncrdsubdoc") === true ? `active` : ""}><a href="#grncrdsubdoc">Green Cards Submission Documents</a></li>
                                                <li class={getCurrentState(pageLocation, "grncrdappprcss") === true ? `active` : ""}><a href="#grncrdappprcss">Green Cards Application Process</a></li>
                                                <li class={getCurrentState(pageLocation, "immiprocess") === true ? `active` : ""}><a href="#immiprocess">Immigration Process & Interview</a></li>
                                                <li class={getCurrentState(pageLocation, "prepintrv") === true ? `active` : ""}><a href="#prepintrv">Preparation for Interview</a></li>
                                                <li class={getCurrentState(pageLocation, "immifee") === true ? `active` : ""}><a href="#immifee">Immigration Fees</a></li>
                                                <li class={getCurrentState(pageLocation, "immires") === true ? `active` : ""}><a href="#immires">Immigration Resources</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                        ...
                                        <ImmigrationLawsListsItem data={docsForGreenCrdContent} />




                                        <div class="contentBox brdrRadius4" id='grncrdappprcss'>
                                        ...
                                        <ImmigrationPrcssIntrv data={immigrationProcessAndInterview} />



                                        <ImmigrationLawsListsItem data={prepForIntrvw} />



                                        <div class="contentBox brdrRadius4" id='immifee'>
                                        ...
                                        <div class="contentBox brdrRadius4" id='immires'>
